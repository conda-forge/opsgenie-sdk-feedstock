...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opsgenie-sdk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14957&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opsgenie-sdk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opsgenie-sdk` can be installed with:

```
conda install opsgenie-sdk
```

It is possible to list all of the versions of `opsgenie-sdk` available on your platform with:
